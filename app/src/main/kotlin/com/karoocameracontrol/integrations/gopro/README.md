...
Examples of the GoPro integration and communications with the device can be found in the [Kotlin tutorial here](https://github.com/gopro/OpenGoPro/tree/main/demos/kotlin/tutorial).

The possibilities of the Open GoPro API can be found in the [OpenGoPro BLE specification here](https://gopro.github.io/OpenGoPro/ble/index.html).
